<template>
  ...
  >
    ...
    <div class="flex justify-center gap-2 mt-4 lg:gap-6">
      <button class="px-3 py-1 bg-red-500 text-white rounded" @click="$emit('confirmDelete')">
        是
      </button>
      <button class="px-3 py-1 bg-gray-300 text-black rounded" @click="$emit('cancel')">否</button>
    </div>
  </div>
