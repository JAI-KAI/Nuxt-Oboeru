		...
		>
			...
			>
				...
				>
					<Icon
						name="i-uis:star"
						class="absolute hover:text-yellow-400 text-3xl"
						:class="[word.isFavorite ? 'text-yellow-400' : 'text-transparent', fliped ? 'z-0' : 'z-50']"
					/>
					<Icon
						name="i-uil:star"
						class="absolute text-yellow-400 text-3xl"
					/>
				</button>
				<p
					class="font-bold absolute top-5 end-5"
					:class="{
				...
				<p class="dark:text-gray-100 text-2xl font-bold text-center">
					{{ word.word }}
				</p>
			...
			>
				...
				>
					<Icon
						name="i-mage:edit-pen"
						class="absolute hover:text-blue-300 text-xl lg:text-3xl z-50"
					/>
				</button>
				<button
				...
				>
					<Icon
						name="i-line-md:trash"
						class="absolute hover:text-red-400 text-xl lg:text-3xl"
						:class="fliped ? 'z-50' : 'z-0'"
					/>
				</button>
				<p class="dark:text-gray-100 p-3">
					{{ word.meaning_zh }}
				</p>
