<template>
	<div class=" px-1 xl:px-24 py-6">
		<!-- 主標題 -->
		<h1 class="text-xl font-bold text-blue-600 dark:text-white text-center mb-4">
			關於本站
		</h1>
		<h3 class="text-lg font-bold text-blue-600 dark:text-white text-center mb-4">
			JLPT
			日語單字學習工具，提供單字瀏覽、收藏、測驗模式，幫助學習者更有效率記憶日語單字。
		</h3>
		<!-- 內容區域 -->
